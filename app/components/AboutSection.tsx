      ...
      <div className=" pb-12 md:pt-16 md:pb-48">
        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:flex-row md:text-left md:p-4 md:space-y-0 md:space-x-10">
          <div className="md:w-1/2">
            ...
            <br />
            <p>
              I graduated from The Cooperative University Of Kenya, Nairobi in
              2022 with a BS in Computer Science with a Second class upper
              division and have been working in the field ever since.
            </p>
            <br />
            <p>
